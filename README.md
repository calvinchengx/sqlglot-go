...
|---|---|---|---|---|---|
| neutral | 997/997 | 492 | 997 | 505 | 0 |
| tsql | 597/597 | 265 | 597 | 332 | 0 |
| postgres | 857/857 | 371 | 857 | 486 | 0 |
| duckdb | 1631/1631 | 1043 | 1631 | 588 | 0 |
| databricks | 424/424 | 216 | 424 | 208 | 0 |
<!-- coverage:end -->
...
string for string: **2,257 of the statements it parses are written back
identically and none is written wrongly**, with 110 refused, and the guard's own rewrite -- inject a row ceiling, emit --
