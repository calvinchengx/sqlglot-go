...
|---|---|---|---|---|---|
| neutral | 997/997 | 523 | 997 | 474 | 0 |
| tsql | 597/597 | 275 | 597 | 322 | 0 |
| postgres | 857/857 | 402 | 857 | 455 | 0 |
| duckdb | 1631/1631 | 1119 | 1631 | 512 | 0 |
...
string for string: **2,406 of the statements it parses are written back
...
becomes. **214 are folded exactly**; the rest the port declines to fold that
