...
| duckdb | 1631/1631 | 961 | 1631 | 670 | 0 |
...
string for string: **2,011 of the statements it parses are written back
identically and none is written wrongly**, with 150 refused, and the guard's own rewrite -- inject a row ceiling, emit --
