...
string for string: **2,042 of the statements it parses are written back
identically and none is written wrongly**, with 119 refused, and the guard's own rewrite -- inject a row ceiling, emit --
