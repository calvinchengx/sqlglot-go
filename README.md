...
string for string: **2,062 of the statements it parses are written back
identically and none is written wrongly**, with 99 refused, and the guard's own rewrite -- inject a row ceiling, emit --
