...
string for string: **2,020 of the statements it parses are written back
identically and none is written wrongly**, with 141 refused, and the guard's own rewrite -- inject a row ceiling, emit --
