...
|---|---|---|---|---|---|
| neutral | 997/997 | 469 | 997 | 528 | 0 |
| tsql | 597/597 | 216 | 597 | 381 | 0 |
| postgres | 857/857 | 336 | 857 | 521 | 0 |
| duckdb | 1631/1631 | 840 | 1631 | 791 | 0 |
| databricks | 424/424 | 172 | 424 | 252 | 0 |
<!-- coverage:end -->
...
string for string: **1,841 of the statements it parses are written back
identically and none is written wrongly**, with 172 refused, and the guard's own rewrite -- inject a row ceiling, emit --
