...
|---|---|---|---|---|---|
| neutral | 997/997 | 473 | 997 | 524 | 0 |
| tsql | 597/597 | 232 | 597 | 365 | 0 |
| postgres | 857/857 | 342 | 857 | 515 | 0 |
| duckdb | 1631/1631 | 894 | 1631 | 737 | 0 |
| databricks | 424/424 | 173 | 424 | 251 | 0 |
<!-- coverage:end -->
...
string for string: **1,916 of the statements it parses are written back
identically and none is written wrongly**, with 178 refused, and the guard's own rewrite -- inject a row ceiling, emit --
